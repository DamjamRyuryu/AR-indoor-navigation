...
/* 
 * This script class is inherited from UserInterface, which is the most important script for the UI and API communication of this demo
 * It is based on an online script for a left-to-right scrolling menu display (https://github.com/NRatel/Unity-ListView). 
 * Just ignore this and go to UserInterface.cs to see the comments.
